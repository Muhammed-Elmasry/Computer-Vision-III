...
for split in ['train', 'test', 'all', '01', '02', '03', '04', '05', '06', '07', '08', '09',
              '10', '11', '12', '13', '14', 'reid', 'train_wo_val', 'train_wo_reid', 'val']:
    name = f'MOT16-{split}'
...
class MOT16Sequences():
    ...
    def __init__(self, dataset, root_dir, **kwargs):
        ...
        # self._data = _sets[dataset]("/content/gdrive/MyDrive/masters/CVIII/datasets/MOT16", **kwargs)
...
class MOT16(Dataset):
    ...
    def __init__(self, root_dir, split, **kwargs):
        ...
        # ------------------- new ------------------
        reid_sequences = ["MOT16-02", "MOT16-05", "MOT16-09", "MOT16-11"]
        val_sequences = ["MOT16-02", "MOT16-11"]
        # ------------------- ---- ------------------
        ...
        # ------------------- new ------------------
        elif "train_wo_reid" == split:
            sequences = [seq for seq in train_sequences if seq not in reid_sequences]
